...
class ListsSuite extends munit.FunSuite:
  ...
  test("sum of a few numbers, with zeroes and negative numbers (10pts)") {
    assertEquals(sum(List(-3, 7, -2, 0, 0)), 2)
  }

  test("max of an empty list throws NoSuchElementException (10pts)") {
